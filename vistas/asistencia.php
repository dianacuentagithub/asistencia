...
<?php 
 //include '../ajax/asistencia.php' ?>
  ...
  <div class="lockscreen-logo">
    <a href="#"><b>CONTROL</b><br>de <br> ASISTENCIA</a>
  </div>
  <!-- User name -->
  <!-- <div class="lockscreen-name">INGRESA TU ID DE EMPLEADO</div> -->
  ...
  <div class="lockscreen-item">
    ...
    <form  action="" class="lockscreen-credentials" name="formulario" id="formulario" method="POST">
      <div class="input-group">
        <input type="password" class="form-control" name="codigo_persona" id="codigo_persona" placeholder="Ingresa tu ID de asistencia">
